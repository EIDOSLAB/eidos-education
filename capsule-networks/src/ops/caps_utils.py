...
def routing(routing_method, num_iterations, votes, logits, routing_bias, input_caps_activations, squashing="hinton"):
    """
    ...
    return dynamic_routing(num_iterations, votes, logits, routing_bias, squashing)


def dynamic_routing(num_iterations, votes, logits, routing_bias, squashing="hinton"):
    """
...
def convolution_caps(input_caps_poses, transform_matr, kernel_size, stride, output_caps_shape, device):
    """
